...
func main() {
	...
	req := texttospeechpb.SynthesizeSpeechRequest{
		...
		Input: &texttospeechpb.SynthesisInput{
			InputSource: &texttospeechpb.SynthesisInput_Ssml{Ssml: "<speak><p>Question: What is the best Christmas present in the world?<break time=\"2.5s\"/>Answer: A broken drum, you just can’t beat it!</p></speak>"},
		},
